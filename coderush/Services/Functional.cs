    ...
    public class Functional : IFunctional
    {
        ...
        public async Task InitAppData()
        {
            try
            {
                ...
                await _context.SupplierType.AddAsync(new SupplierType { SupplierTypeName = "Default" });
                await _context.SaveChangesAsync();

                await _context.Supplier.AddRangeAsync(new List<Supplier>() {
                    ...
                    new Supplier{SupplierName = "Mayumi's", Address = "92 Setsuko Chuo-ku"},
                    new Supplier{SupplierName = "Pavlova, Ltd.", Address = "74 Rose St. Moonie Ponds"},
                    new Supplier{SupplierName = "Specialty Biscuits, Ltd.", Address = "29 King's Way"},
                    new Supplier{SupplierName = "PB Knäckebröd AB", Address = "Kaloadagatan 13"},
                    new Supplier{SupplierName = "Refrescos Americanas LTDA", Address = "Av. das Americanas 12.890"},
                    new Supplier{SupplierName = "Heli Süßwaren GmbH & Co. KG", Address = "Tiergartenstraße 5"},
                    ...
                    new Supplier{SupplierName = "Formaggi Fortini s.r.l.", Address = "Viale Dante, 75"},
                    new Supplier{SupplierName = "Norske Meierier", Address = "Hatlevegen 5"},
                    new Supplier{SupplierName = "Bigfoot Breweries", Address = "3400 - 8th Avenue Suite 210"},
                    new Supplier{SupplierName = "Svensk Sjöföda AB", Address = "Brovallavägen 231"},
                    new Supplier{SupplierName = "Aux joyeux ecclésiastiques", Address = "203, Rue des Francs-Bourgeois"},
                    new Supplier{SupplierName = "New England Seafood Cannery", Address = "Order Processing Dept. 2100 Paul Revere Blvd."}
                });
                await _context.SaveChangesAsync();


                await _context.InventoryType.AddRangeAsync(new List<InventoryType>() {
                    new InventoryType{InventoryTypeId = 1, InventoryTypeName = "GoodsReceivedNote"},
                });
